document.onselectstart=new Function('event.returnValue=false;');//禁止图片被选取
window.onload = function(){
	var boxDiv = document.getElementById('main');//外层容器
	var mainDiv = document.getElementById('cut');//选择层
	var leftUpDiv = document.getElementById('left-top');//左上角触点
	var leftDiv = document.getElementById('left-middle');//左中间触点
	var leftDownDiv = document.getElementById('left-bottom');//左下角触点
	var upDiv = document.getElementById('middle-top');//上中间触点
	var downDiv = document.getElementById('middle-bottom');//下中间触点
	var rightUpDiv = document.getElementById('right-top');//右上角触点
	var rightDiv = document.getElementById('right-middle');//右中间触点
	var rightDownDiv = document.getElementById('right-bottom');//右下角触点
...
*/
	...
	function fnMove(e,posX,posY){
		 var oDrag=document.getElementById('cut'),
	     l=e.clientX-posX,
	     t=e.clientY-posY,
	...
	cut.onmousedown=function fnDown(event){
